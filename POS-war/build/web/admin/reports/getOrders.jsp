...
<html>
    ...
    <body>
        <div class="container">
            <div class="header">
                <div class="breadcrumb"><a href="../index.jsp">Home</a> > <a href="index.jsp">Reports</a> > Get Orders<div class="right"><a href="../../AdminLoginController?logout">Logout</a></div></div>
             ...
             <form class="login" method="get" action="../../ReportController">
                <div class="grid">
                    <input type="hidden" value="e2" name="sent">
                ...
                <div class="footer">
                    <div class="right"> 
                        <button type="submit" name="getOrders">Export</button>
                    </div>
                </div>
             </form>
        </div>
