...
<html>
    ...
    <body>
        <div class="container">
            <div class="header">
                <div class="breadcrumb"><a href="index.jsp">Home</a> > <a href="itemManager.jsp">Item Manager</a> > Add Item<div class="right"><a href="../AdminLoginController?logout">Logout</a></div></div>
            ...
            <div class="grid employeeEdit">
                <form class="employeeEdit" action="../ItemController?add" method="get">
                    <table class="employeeEdit">
                    <input type="hidden" id="itemNo" value="" name="itemNo"></td>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" id="itemDesc" value="" name="itemDesc"></td>
                        </tr>
                    </table>
                    <table class="employeeEdit">
                        <tr>
                            ...
                            <td clas="nopadding">
                                <table class="inner">
                                    <tr>
                                        <td><input type="number" name="basePrice" min="0" max="9999" step="0.01" size="4" title="CDA Currency Format - no dollar sign and no comma(s) - cents (.##) are optional" value=""></td>
                                        <td><label for="cost">Cost: </label></td>
                                        <td><input type="number" id="cost" name="cost" min="0" max="9999" step="0.01" size="4" title="CDA Currency Format - no dollar sign and no comma(s) - cents (.##) are optional" value=""></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td clas="nopadding">
                                <table class="inner">
                                    <tr>
                                       <td><input type="number" id="numberOfSides" min="0" max="3" value="0" name="numberOfSides"></td>
                                        <td><label for="cost"># of extras: </label></td>
                                        <td><input type="number" id="extras" name="extras" min="0" max="3" step="1" title="" value="0"></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                    ...
                    <div class="">
                        <table class="employeeEdit extrasView nopadding">
                            <tr data-id='0' class='hidden'>
                                ...
                                <td width=250px>
                                    <input type='text' class='extraName' name='extra1Name' placeholder='Extra Name' value=''>
                                    <input type='number' class='extraPrice' name='extra1Price' placeholder='Extra Price' value=''>
                                ...
                                <td>
                                    ...
                                    <input type='hidden' name='extras1' class='extras' value=''>
                                </td>
                            </tr>
                            <tr data-id='1' class='hidden'>
                                <td>Name: <p>Price: <p> Add Extra:</td>
                                <td width=250px>
                                    <input type='text' class='extraName' name='extra2Name' placeholder='Extra Name' value=''>
                                    <input type='number' class='extraPrice' name='extra2Price' placeholder='Extra Price' value=''>
                                    <input class='extraAdd' type=text>
                                    <div class='extras button add'>Add</div>
                                </td>
                                <td>
                                    <span class="currentExtrasText">Current Extras (click to remove):</span>
                                    <div class='currentExtras'></div>
                                    <input type='hidden' name='extras2' class='extras' value=''>
                                </td>
                            </tr>
                            <tr data-id='2' class='hidden'>
                               <td>Name: <p>Price: <p> Add Extra:</td>
                                <td width=250px>
                                    <input type='text' class='extraName' name='extra3Name' placeholder='Extra Name' value=''>
                                    <input type='number' class='extraPrice' name='extra3Price' placeholder='Extra Price' value=''>
                                    <input class='extraAdd' type=text>
                                    <div class='extras button add'>Add</div>
                                </td>
                                <td>
                                    <span class="currentExtrasText">Current Extras (click to remove):</span>
                                    <div class='currentExtras'></div>
                                    <input type='hidden' name='extras3' class='extras' value=''>
                                </td>
                            </tr>
                        </table>
                    </div>
                    <table class="employeeEdit">
                        <tr>
                            ...
                            <td><div class="select"><select name="itemType"><option selected=selected>Main</option><option>Side</option><option>Drink</option><option>Appetizer</option><option>Dessert</option><option>Speed Bar</option></div></td>
                        </tr>
                        <tr>
                            <td><label for="isActive">Enabled:</label></td>
                            <td><input type="checkbox" id="isActive" name="isActive" checked></td>
                        </tr>
                    </table>
              
            </div>
            
            <input type="hidden" name="specials" id="delimiter">
            <div class="footer">
                <div class="right">
